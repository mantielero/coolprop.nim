{.passL:"-lCoolProp -ldl".}
{.passC:"-std=c++11 -Wall -I/usr/include/fmt -I/usr/include/CoolProp" .}
import cppstl
##
...
proc PropsSI*(Output: CppString; Name1: CppString; Prop1: cdouble; Name2: CppString;
             Prop2: cdouble; FluidName: CppString): cdouble {.
    importcpp: "CoolProp::PropsSI(@)", dynlib:"libCoolProp.so".}#header: "CoolProp.h".}
## *
...
proc get_debug_level*(): cint {.importcpp: "CoolProp::get_debug_level(@)",
                                dynlib:"libCoolProp.so".}#header: "CoolProp.h".}
## / Set the debug level
